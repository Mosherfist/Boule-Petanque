...
def deutsch_englisch(i):
    global en_bit, de_bit, ges_bit  ##todo klären
    ...
    if eingabe == englisch:
        print("Richtig")
        en_bit = 1
    if de_bit == 1:  #todo klären
        ges_bit *= 2
    # db_update(aufruf)
    else:
        print("Falsche Antwort")
    i = (num, deutsch, englisch, de_bit, en_bit, ges_bit)
    print(i)
    return i

def englisch_deutsch(i):
    global en_bit, de_bit, ges_bit  ##todo klären
...
for i in gr_begriffe:
    ...
    if en_bit == 0:
        ...
        if eingabe == deutsch:
            print("Richtig")
            de_bit = 1
            if en_bit == 1:   ##todo klären, rausnehmen, da doppelt
                ges_bit *= 2
        else:
            print("Falsche Antwort")
